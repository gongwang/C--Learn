========================================================================
    ACTIVEX CONTROL DLL : OcxTest Project Overview
========================================================================

ControlWizard has created this project for your OcxTest ActiveX Control
...
that make up your OcxTest ActiveX Control DLL.
...
OcxTest.ico
    ...
    is included by the main resource file OcxTest.rc.

/////////////////////////////////////////////////////////////////////////////
COcxTestCtrl control:

OcxTestCtrl.h
    This file contains the declaration of the COcxTestCtrl C++ class.

OcxTestCtrl.cpp
    This file contains the implementation of the COcxTestCtrl C++ class.

OcxTestPropPage.h
    This file contains the declaration of the COcxTestPropPage C++ class.

OcxTestPropPage.cpp
    This file contains the implementation of the COcxTestPropPage C++ class.

COcxTestCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    COcxTestCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file OcxTest.rc.
...
stdafx.h, stdafx.cpp
    ...
    named OcxTest.pch and a precompiled types (PCT) file named stdafx.obj.
