========================================================================
    ACTIVEX CONTROL DLL : onlytest Project Overview
========================================================================

ControlWizard has created this project for your onlytest ActiveX Control
...
that make up your onlytest ActiveX Control DLL.
...
onlytest.ico
    ...
    is included by the main resource file onlytest.rc.

/////////////////////////////////////////////////////////////////////////////
ConlytestCtrl control:

onlytestCtrl.h
    This file contains the declaration of the ConlytestCtrl C++ class.

onlytestCtrl.cpp
    This file contains the implementation of the ConlytestCtrl C++ class.

onlytestPropPage.h
    This file contains the declaration of the ConlytestPropPage C++ class.

onlytestPropPage.cpp
    This file contains the implementation of the ConlytestPropPage C++ class.

ConlytestCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    ConlytestCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file onlytest.rc.
...
stdafx.h, stdafx.cpp
    ...
    named onlytest.pch and a precompiled types (PCT) file named stdafx.obj.
