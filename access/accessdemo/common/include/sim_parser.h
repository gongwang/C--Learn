...
const static CodeMsg STATUS_CREATED = {201,"Created"};
const static CodeMsg STATUS_NO_CONTENT = {204,"No Content"};
const static CodeMsg STATUS_MOVED_PERMANENTLY = {301,"Moved Permanently"};
const static CodeMsg STATUS_UNAUTHORIZED = {401,"Unauthorized"};
...
class Response {
    public:
       ...
       //Response(CodeMsg status_code, Json::Value &body);
        ...
        std::string get_head(const std::string &name);
        ...
        //int parse_multi_params();
        std::vector<FileItem> *get_file_items(){return &_file_items;}
