========================================================================
    ACTIVEX CONTROL DLL : mwplayer Project Overview
========================================================================

ControlWizard has created this project for your mwplayer ActiveX Control
...
that make up your mwplayer ActiveX Control DLL.
...
mwplayer.ico
    ...
    is included by the main resource file mwplayer.rc.

/////////////////////////////////////////////////////////////////////////////
CmwplayerCtrl control:

mwplayerCtrl.h
    This file contains the declaration of the CmwplayerCtrl C++ class.

mwplayerCtrl.cpp
    This file contains the implementation of the CmwplayerCtrl C++ class.

mwplayerPropPage.h
    This file contains the declaration of the CmwplayerPropPage C++ class.

mwplayerPropPage.cpp
    This file contains the implementation of the CmwplayerPropPage C++ class.

CmwplayerCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CmwplayerCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file mwplayer.rc.
...
stdafx.h, stdafx.cpp
    ...
    named mwplayer.pch and a precompiled types (PCT) file named stdafx.obj.
