...
// CDrivePasswordLists wrapper class

class CDrivePasswordLists : public COleDispatchDriver
{
public:
	CDrivePasswordLists(){} // Calls COleDispatchDriver default constructor
...
public:
	...
	// _DrivePasswordLists properties
public:
