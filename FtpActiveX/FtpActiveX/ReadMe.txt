========================================================================
    ACTIVEX CONTROL DLL : FtpActiveX Project Overview
========================================================================

ControlWizard has created this project for your FtpActiveX ActiveX Control
...
that make up your FtpActiveX ActiveX Control DLL.
...
FtpActiveX.ico
    ...
    is included by the main resource file FtpActiveX.rc.

/////////////////////////////////////////////////////////////////////////////
CFtpActiveXCtrl control:

FtpActiveXCtrl.h
    This file contains the declaration of the CFtpActiveXCtrl C++ class.

FtpActiveXCtrl.cpp
    This file contains the implementation of the CFtpActiveXCtrl C++ class.

FtpActiveXPropPage.h
    This file contains the declaration of the CFtpActiveXPropPage C++ class.

FtpActiveXPropPage.cpp
    This file contains the implementation of the CFtpActiveXPropPage C++ class.

CFtpActiveXCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CFtpActiveXCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file FtpActiveX.rc.
...
stdafx.h, stdafx.cpp
    ...
    named FtpActiveX.pch and a precompiled types (PCT) file named stdafx.obj.
